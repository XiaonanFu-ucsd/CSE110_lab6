...
function addRecipesToDocument(recipes) {
    ...
    console.log("add recipes to document", recipes.length)
    ...
    for (let i = 0; i < recipes.length; i++) {
        ...
        console.log("add 1 recipe to document", i)
        mainHTML.appendChild(recipeCard);
    }
}
...
function initFormHandler() {
    ...
    let formHTML = document.getElementsByTagName('form')[0];
    ...
    formHTML.addEventListener('submit', function(event) {
        ...
        console.log("add 1 recipe to document")
